...
public class EmiLOADView extends JFrame {
	...
	JPanel dialogPanel, sourceLoginPanel, loginPanel, unlockedCoursesPanel,
			saveDir, dialogResult;
	JScrollPane ucp;
	...
	public EmiLOADView() {
		...
		// Die URL festlegen, die geparsed werden und als Hauptnavigation werden
		// soll
		// Als Variable, damit sie im Falle einer Veränderung schnell angepasst
		// werden kann
			...
			public void actionPerformed(ActionEvent submitKlicked) {
				...
				try {
					Connection.Response res = Jsoup
							...
							// TODO für "password" den Input des passwordID
							// String
					...
					// Selektiert aus den gefilterten Links nur den jeweiligen
					// Titel
...
///////////////////////////////////////////////////////////////////////////////
					...
					for (Element title : titles) {
						...
						for (int i = 0; i < course.length; i++) {
							...
							check= new JCheckBox(course[i]);
							unlockedCoursesPanel.add(check);
					...
					System.out.println("fertige checkBox: "+ checkBox + "Anzahl: " + checkBox.size());
...
/////////////////////////////////////////////////////////////////////////////////
		...
		open.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				/*
				 * // if (saveDirChooser.showSaveDialog(this) ==
				 * JFileChooser.APPROVE_OPTION) {
				 * System.out.println("getCurrentDirectory(): " +
				 * saveDirChooser.getCurrentDirectory());
				 * System.out.println("getSelectedFile() : " +
				 * saveDirChooser.getSelectedFile());
				 * saveDirField.setText(saveDirChooser
				 * .getSelectedFile().getPath()); } else {
		...
		JLabel courseLabel = new JLabel(
				"Angemeldete Kurse zum Synchronisieren von "
						+ userIDField.getText());
